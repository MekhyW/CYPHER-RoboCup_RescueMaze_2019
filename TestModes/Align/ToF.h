...
void ReadToF(){
  ToFFrontCT = ((FrontCT.readRangeContinuousMillimeters()+60)*0.5)+(ToFFrontCT*0.5);
  ToFFrontA = ((FrontA.readRangeContinuousMillimeters()+60)*0.5)+(ToFFrontA*0.5);
  ToFFrontB = ((FrontB.readRangeContinuousMillimeters()+60)*0.5)+(ToFFrontB*0.5);
  ToFRightCT = ((RightCT.readRangeContinuousMillimeters()+60)*0.5)+(ToFRightCT*0.5);
  ToFRightA = ((RightA.readRangeContinuousMillimeters()+60)*0.5)+(ToFRightA*0.5);
  ToFRightB = ((RightB.readRangeContinuousMillimeters()+60)*0.5)+(ToFRightB*0.5);
  ToFLeftCT = ((LeftCT.readRangeContinuousMillimeters()+60)*0.5)+(ToFLeftCT*0.5);
  ToFLeftA = ((LeftA.readRangeContinuousMillimeters()+60)*0.5)+(ToFLeftA*0.5);
  ToFLeftB = ((LeftB.readRangeContinuousMillimeters()+60)*0.5)+(ToFLeftB*0.5);
  ToFBackCT = ((BackCT.readRangeContinuousMillimeters()+60)*0.5)+(ToFBackCT*0.5);
  ToFBackA = ((BackA.readRangeContinuousMillimeters()+60)*0.5)+(ToFBackA*0.5);
  ToFBackB = ((BackB.readRangeContinuousMillimeters()+60)*0.5)+(ToFBackB*0.5);
}
